...
$(BIN)/$(CLIENT_EXECUTABLE_DEBUG): $(CLIENT_SRC_PATH)/*.cpp
	$(MAKE) -C $(CLIENT_PATH) debug

$(BIN)/$(SERVER_EXECUTABLE): $(SERVER_SRC_PATH)/*.cpp
	$(MAKE) -C $(SERVER_PATH) all

$(BIN)/$(SERVER_EXECUTABLE_DEBUG): $(SERVER_SRC_PATH)/*.cpp
...
clean: 
	-rm $(BIN)/$(CLIENT_EXECUTABLE) $(BIN)/$(CLIENT_EXECUTABLE_DEBUG) $(BIN)/$(SERVER_EXECUTABLE) $(BIN)/$(SERVER_EXECUTABLE_DEBUG)
